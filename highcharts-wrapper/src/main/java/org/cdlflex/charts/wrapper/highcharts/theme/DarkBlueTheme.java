...
public class DarkBlueTheme extends Theme {
    ...
    public DarkBlueTheme() {
        ...
        this.setColors(HexColor.fromStrings("#DDDF0D", "#55BF3B", "#DF5353", "#7798BF", "#aaeeee", "#ff0066",
                                            "#eeaaee",
                                            "#55BF3B", "#DF5353", "#7798BF", "#aaeeee"));

        this.setChartOptions(new ChartOptions()
            .setBackgroundColor(
                                new LinearGradient(0, 0, 250, 500).addStop(0, new RgbaColor(48, 48, 96))
        ...
        this.setxAxis(new Axis()
            ...
            .setTitle(
                      new Title()
                          .setStyle(new CssStyle().setProperty("color", "#cccccc")
        ...
        this.setLegend(new Legend()
            .setItemStyle(
                          new CssStyle().setProperty("font", "9pt Trebuchet MS, Verdana, sans-serif")
