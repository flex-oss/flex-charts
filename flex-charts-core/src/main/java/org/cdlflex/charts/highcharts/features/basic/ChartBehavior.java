...
import org.cdlflex.charts.JavaScriptResourceRegistry;
import org.cdlflex.charts.highcharts.Chart;
import org.cdlflex.charts.highcharts.features.drilldown.DrilldownProcessor;
import org.cdlflex.charts.highcharts.features.global.GlobalProcessor;
import org.cdlflex.charts.highcharts.features.interaction.InteractionProcessor;
import org.cdlflex.charts.highcharts.features.livedata.LiveDataProcessor;
import org.cdlflex.charts.highcharts.features.selection.SelectionProcessor;
...
import org.cdlflex.charts.wrapper.highcharts.options.processing.Feature;
import org.cdlflex.charts.wrapper.highcharts.options.processing.FeatureCheckingOptionsProcessor;
import org.cdlflex.charts.wrapper.highcharts.options.processing.IOptionsProcessor;
import org.cdlflex.charts.wrapper.highcharts.options.processing.IdGeneratorProcessor;
    ...
    protected void includeChartJavascript(final IHeaderResponse response, final Options options,
        ...
        response
            .render(OnDomReadyHeaderItem.forScript(MessageFormat.format(
                                                                        "var {0} = {1};window.{2} = new Highcharts.Chart({0});",
                                                                        optionsVarname, renderer.toJson(options),
                                                                        chartVarname)));
    }
