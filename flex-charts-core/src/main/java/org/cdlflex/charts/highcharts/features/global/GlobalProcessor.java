 ...
 */
package org.cdlflex.charts.highcharts.features.global;
...
/**
 * This processor reads the global options from an {@link Options} object and calls Highcharts' setOptions function to
 * use the options globally for all charts.
 *
 * If more than one chart with global options are on a single page, the global options of the last chart override all
 * others!
 *
