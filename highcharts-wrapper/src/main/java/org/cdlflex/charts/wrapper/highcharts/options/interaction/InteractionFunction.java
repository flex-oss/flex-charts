 ...
 */
package org.cdlflex.charts.wrapper.highcharts.options.interaction;
...
/**
 * This javascript function sends an AJAX request to the server. That request contains some information about what point
 * and series the user has selected in the chart. That information is available on the server side as an
...
public abstract class InteractionFunction extends Function implements IProcessableOption {
    ...
    /**
     * The key under which {@link InteractionFunction}s are registered in the parent options. See
     ...
     * Constructor.
     * 
     * @param parentOptions the Options object that contain this function.
     */
    ...
    /**
     * This method is called on the server side when the {@link InteractionFunction} is called on the client side.
     * 
     * @param event the {@link InteractionEvent} containing information about which Point of which Series and which
     *        Chart has been interacted with.
     */
