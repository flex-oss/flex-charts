...
/**
 * This function may be added to a {@link ChartOptions} object via {@link Events#setSelection(Function)}. When the user
 * zooms in or out of chart (i.e. when he selects a portion of the chart), a {@link SelectionEvent} is triggered and
 * transmitted to the server. You can react to this event on the server side by implementing the
 * {@link #onSelect(SelectionEvent)} method.
 * 
...
public abstract class SelectionFunction extends Function implements IProcessableOption {
    ...
    /**
     * This method is called on the server side when the user selected a portion of the chart (i.e. when he zoomed in or
     * out).
     * 
     * @param event the selection event containing some information about which portions of the chart have been
     *        selected.
     */
