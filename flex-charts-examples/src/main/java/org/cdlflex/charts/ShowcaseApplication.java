...
import org.cdlflex.charts.ie.SimplePage;
import org.cdlflex.charts.modalwindow.ModalWindowPage;
...
public class ShowcaseApplication extends WebApplication {
    ...
    public void init() {
        ...
        JavaScriptResourceRegistry
            .getInstance()
            .setJQueryReference(new JavaScriptResourceReference(ShowcaseApplication.class,
