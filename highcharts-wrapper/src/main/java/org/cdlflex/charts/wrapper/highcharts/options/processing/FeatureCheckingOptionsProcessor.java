...
/**
 * This {@link IOptionsProcessor} checks if the {@link Options} object contains certain features that may not be
 * supported by all interpreters and throws an exception if a feature is not supported. The supported features are
