...
/**
 * This event can be reacted upon server side when a {@link SelectionFunction} has been added to a chart. The event is
 * fired when the user selects (zooms) a portion of the chart.
 * 
...
public class SelectionEvent extends BaseEvent {
    ...
    /**
     * Returns information about which portions of which x-axes the user has selected (zoomed).
     *
    ...
    /**
     * Returns information about which portions of which y-axes the user has selected (zoomed).
     * 
     * @return retuns the y axis
     */
