...
/**
 * Demo of the same spline chart with symbols as in the Highcharts demo at <a href
 * ="http://www.highcharts.com/demo/spline-symbols">http://www.highcharts.com /demo/spline-symbols</a>.
 * 
...
public class SplineWithSymbolsOptions extends ShowcaseOptions {
    ...
    public SplineWithSymbolsOptions() {
        ...
        series1Marker
            .setSymbol(new Symbol(Symbol.PredefinedSymbol.SQUARE));
        ...
        series1Marker
            .setSymbol(new Symbol(Symbol.PredefinedSymbol.DIAMOND));
