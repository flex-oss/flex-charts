...
public class InteractionEvent extends BaseEvent {
     ...
     * 
     * @return the {@link Series} the user interacted with. This value must never be null.
     */
     ...
     * 
     * @return the {@link Point} the user interacted with. This value may be null if the user interacted with a
     *         {@link Series} and not directly with a {@link Point}.
     */
