...
/**
 * A {@link ColorReference} defining a linear gradient with one or more changes between colors.
 * 
...
public class LinearGradient extends Gradient {
     ...
     *
     * @param x1 x-axis percentage of the starting point of the gradient. Must be a value between 0 and 1.
     * @param y1 y-axis percentage of the starting point of the gradient. Must be a value between 0 and 1.
     * @param x2 x-axis percentage of the ending point of the gradient. Must be a value between 0 and 1.
     * @param y2 y-axis percentage of the ending point of the gradient. Must be a value between 0 and 1.
     */
