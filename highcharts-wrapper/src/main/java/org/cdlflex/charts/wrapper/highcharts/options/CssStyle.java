 ...
 * 
 * @see <a href="http://api.highcharts.com/highcharts#chart.style">http://api.highcharts.com/highcharts#chart.style</a>
...
public class CssStyle implements Serializable {
     ...
     * Sets a CSS property.
     * 
     * @param key the name of the property. Note that hyphen notation ("-") is automatically converted into camel case
     *        notation since the property name is used as key in a JSON object. Highcharts will evaluate it as if it
     *        were hyphen notation.
     ...
     * 
     * @param propertyName the name of the CSS property to sanitize
