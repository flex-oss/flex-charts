...
/**
 * A {@link ColorReference} referencing a color managed by Highcharts. Highcharts provides a set colors accessible by an
 * index.
 * 
...
public class HighchartsColor extends ColorReference {
     ...
     * 
     * @param highchartsIndex the index under which Highcharts manages the wanted color.
     */
