...
/**
 * Defines the interval between two tick marks. Can be either a number or you can let Highcharts decide the value
 * (auto).
 * 
...
public class MinorTickInterval implements Serializable {
     ...
     *
     * @return the MinorTickInterval for chaining
     */
