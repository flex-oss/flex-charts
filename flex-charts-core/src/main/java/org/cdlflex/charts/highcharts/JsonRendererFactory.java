 ...
 */
package org.cdlflex.charts.wrapper.highcharts;

import org.cdlflex.charts.wrapper.highcharts.jackson.JsonRenderer;

/**
 * Factory class responsible for creating a {@link JsonRenderer} instance that matches the needs of
...
public class JsonRendererFactory {
    ...
    /**
     * Returns the singleton instance of the {@link JsonRenderer} that is configured for Wicket 6.x.
     *
