...
import org.cdlflex.charts.wrapper.highcharts.json.JsonValueEnum;

/**
 * Possible values for mime type of exported images.
 * 
 * @see <a href="http://api.highcharts.com/highcharts#exporting.type">http://api.highcharts.com/highcharts#exporting.
 *      type</a>
 * 
