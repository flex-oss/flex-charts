...
/**
 * A javascript function intended to use as tooltip formatter. If used as tooltip formatter, it displays the total value
 * and the value of the selected stack of a stacked bar or column chart.
 * 
...
public class StackTotalFormatter extends Function {
    ...
    public StackTotalFormatter() {
        setFunction("return '<b>'" + "+ this.x " + "+'</b><br/>'" + "+this.series.name +': '" + "+ this.y "
            + "+'<br/>'"
