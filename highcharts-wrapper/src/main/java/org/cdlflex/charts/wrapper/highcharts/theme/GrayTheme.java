...
/**
 * Gray theme as displayed in the Highcharts demo at
 * <a href="http://www.highcharts.com/demo/column-stacked-and-grouped/gray" >http://www.highcharts.com/demo/column-
 * stacked-and-grouped/gray</a>
 * 
...
public class GrayTheme extends Theme {
    ...
    public GrayTheme() {
        this.setColors(HexColor.fromStrings("#DDDF0D", "#7798BF", "#55BF3B", "#DF5353", "#aaeeee", "#ff0066",
                                            "#eeaaee",
        ...
        this.setxAxis(new Axis()
            ...
            .setLabels(new Labels()
                .setStyle(new CssStyle().setProperty("color", "#DDD").setProperty("fontWeight", "bold")))
            .setTitle(
        ...
        this.setPlotOptions(new PlotOptionsChoice()
            .setLine(
                     new PlotOptions().setDataLabels(new DataLabels().setColor(HexColor.fromString("#cccccc")))
                         .setMarker(
        ...
        this.setNavigation(new Navigation().setButtonOptions(new ButtonOptions()
            .setBackgroundColor(
                                new LinearGradient(0, 0, 0, 20).addStop(0.4f, HexColor.fromString("#606060"))
                                    .addStop(0.6f,
                                             HexColor.fromString("#333333")))
            .setBorderColor(HexColor.fromString("#000000"))
            .setSymbolStroke(HexColor.fromString("#c0c0c0"))
            .setHoverSymbolStroke(HexColor.fromString("#ffffff"))));
