 ...
 */
package org.cdlflex.charts.highcharts.features.livedata;
...
public class WicketLiveDataUpdateEvent extends LiveDataUpdateEvent {
    ...
    public WicketLiveDataUpdateEvent(final AjaxRequestTarget ajaxRequestTarget,
            final LiveDataUpdateEvent wrappedEvent) {
