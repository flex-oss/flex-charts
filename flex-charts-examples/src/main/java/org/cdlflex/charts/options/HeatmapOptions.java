...
import org.cdlflex.charts.wrapper.highcharts.options.series.Custom3DCoordinateSeries;
...
public class HeatmapOptions extends ShowcaseOptions {
    ...
    public HeatmapOptions() {
        ...
        setxAxis(new Axis()
            .setCategories("Alexander", "Marie", "Maximilian", "Sophia", "Lukas", "Maria", "Leon", "Anna", "Tim",
                           "Laura"));
