...
/**
 * A {@link ColorReference} that is always rendered as JSON "null". Use this class if you want to explicitly set a color
 * to null to override a Highcharts default.
 * 
